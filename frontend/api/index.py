"""
Vercel serverless Flask entry (lives under frontend/api when outputDirectory=frontend).

Bundled backend is copied to frontend/api/_backend at build time.
"""
import os
import sys
...
for path in (BACKEND, API_DIR, DATABASE_DIR, os.path.dirname(BACKEND)):
